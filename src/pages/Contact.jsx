  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        console.log(
          "[Contact] Message submitted successfully for:",
          values.email
        );
        resetForm();
      ...
      if (err.response?.status === 500) {
        setErrorMessage(
          "Server error. Please try again later or contact us directly at timetomisin@gmail.com"
        );
          ...
          <div className="info-items">
            <div className="info-item">
              ...
              <div className="info-text">
                <h3>Email</h3>
                <p>
                  <a href="mailto:hello@goodheart.org">timetomisin@gmail.com</a>
                </p>
              </div>
            </div>
            <div className="info-item">
              ...
              <div className="info-text">
                <h3>Phone</h3>
                <p>
                  <a href="tel:+919876543210">+234 70 39692720</a>
                </p>
              </div>
            </div>
            <div className="info-item">
              ...
              <div className="info-text">
                <h3>Address</h3>
                <p>
                  No: 21, Akapo Street off Oke-Koto Bstop, Agege, Lagos State.
                </p>
              </div>
            </div>
            <div className="info-item">
